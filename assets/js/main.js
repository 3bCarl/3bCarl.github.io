(function ($) {
	...
	$('.slider-active-3').slick({
		...
		fade:true,
		arrows: true,
		prevArrow: '<button type="button" class="slick-prev"><i class="fa-solid fa-long-arrow-left"></i></button>',
		nextArrow: '<button type="button" class="slick-next"><i class="fa-solid fa-long-arrow-right"></i></button>',
		responsive: [
			{
				breakpoint: 992,
				settings: {
    ...
    $('.team-slider-active').slick({
		slidesToShow: 4,
		arrows: true,
		prevArrow: '<button type="button" class="slick-prev"><i class="fa-solid fa-long-arrow-alt-left"></i></button>',
		nextArrow: '<button type="button" class="slick-next"><i class="fa-solid fa-long-arrow-alt-right"></i></button>',
		responsive: [
			{
				breakpoint: 1200,
				settings: {
